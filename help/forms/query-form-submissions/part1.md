...
表單中可搜尋的欄位通常是指表單內可做為搜尋或篩選提交資料條件的欄位。
出於此使用案例的目的，下列欄位型別已擴充為可搜尋

* 核取方塊群組
* 下拉式清單
* 選項按鈕

表單作者可將這些欄位型別標示為可搜尋，如下所示
![可搜尋的欄位](assets/searchable-fields.png)

欄位已藉由建立下列結構擴充

![延伸欄位](assets/extend-component.png)

以下是.content.xml檔案的內容
