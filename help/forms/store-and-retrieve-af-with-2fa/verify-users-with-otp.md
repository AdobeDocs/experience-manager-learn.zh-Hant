...
若要將AEM/AEM Forms與協力廠商應用程式整合，我們需要 [使用Swagger檔案的REST型資料來源](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/ic-web-channel-tutorial/parttwo.html) 在雲端服務設定中。 完成的資料源將作為本課程資產的一部分提供給您。
