...
若要將AEM/AEM Forms與協力廠商應用程式整合，我們需要使用雲端服務設定中的Swagger檔案 [，以](https://docs.adobe.com/content/help/en/experience-manager-learn/forms/ic-web-channel-tutorial/parttwo.html) REST為基礎的資料來源。 本課程資產會提供您完整的資料來源。
