...
本教學課程將逐步說明在適用性表單提交上建立Campaign設定檔的步驟。 若要完成此使用案例，我們必須執行下列作業
...
若要進一步了解AEM Forms中的自訂提交處理常式，請遵循以下步驟 [連結](/help/forms/adaptive-forms/custom-submit-aem-forms-article.md)
...
* [使用套件管理器匯入適用性表單和自訂提交處理常式](assets/create-acs-profile-on-af-submission.zip).此套件包含設定為提交至自訂提交動作的適用性表單。
...
[使用ACS配置檔案資訊預填最適化表單](./partthree.md)
