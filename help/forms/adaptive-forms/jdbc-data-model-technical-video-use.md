...
# 將基於JDBC的表單資料模型與AEM表單一起使用 {#using-jdbc-based-form-data-models-with-aem-forms}
...
>[!NOTE]
>
>只要所需的資料庫驅動程式部署至AEM做為OSGi套件，就可以使用任何RDBMS資料來源。 在AEM中設定RDBMS資料來源，請參閱「與AEM [表單設定資料整合」](/help/forms/adaptive-forms/data-integration-technical-video-setup.md)。
