...
瞭解如何在Adobe Experience Manager Assetsas a Cloud ServiceContent Hub中上傳資產、套用標籤，以及瞭解核准工作流程。
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">瞭解如何使用Experience Manager Assets Content Hub中的Adobe Express來建立和編輯影像變體。</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">取得Content Hub部分最常見問題(FAQ)的回應。</p>
                </div>
