...
+ 製作{#authoring}
   ...
   + [關聯和不關聯](./authoring/relate-unrelate.md)

+ 協作{#collaboration}
   + [時間軸和收件匣](./collaboration/timeline-and-inbox.md)
   + [註解和註解](./collaboration/comments-and-annotations.md)
...
+ 共用與發佈{#sharing}
   ...
   + 資產共用{#assets-share}
      + [資產共用公域](./sharing/asset-share-commons-user-experience-feature-video-understand.md)
...
+ Adobe資產連結{#adobe-asset-link}
   ...
   + [版本設定與註解](./adobe-asset-link/file-versioning-and-comments.md)
   + [位置副本](./adobe-asset-link/place-copy.md)
   + [置入已連結](./adobe-asset-link/place-linked.md)
   + [僅限版位(FPO)](./adobe-asset-link/for-placement-only.md)
...
+ 動態媒體{#dynamic-media}
   ...
   + 教學課程 {#tutorials}
      ...
      + [觸發匯出作業](dynamic-media/tutorials/how-to-trigger-export-job-in-dynamic-media-during-submit-job-operation-parameter.md)
...
+ 轉換 {#translation}
   + [源檔案翻譯](translation/source-file-translation-feature-video-use.md)
   + [智慧翻譯搜尋](translation/smart-translation-search-feature-video-use.md)
   + [設定智慧翻譯搜尋](translation/smart-translation-search-technical-video-setup.md)
...
+ 部署{#deployment}
   + [多租用戶和同時開發](deployment/multitenancy-concurrent-article-understand.md)
