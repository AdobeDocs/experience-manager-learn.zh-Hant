...
user-guide-description: Adobe Experience Manager Assets 的影片和教學課程集合。
...
+ 影片播放清單{#video-playlists}
   + [資產視圖](playlists/assets-view.md)
   + [管理員視圖](playlists/admin-view.md)

+ 設定{#configuring}
   + [基準線資料夾](configuring/baseline-folders.md)
   + [基準線權限](configuring/baseline-permissions.md)
   + [標記](configuring/tagging.md)
   + [中繼資料結構描述](configuring/metadata-schemas.md)
   + [中繼資料設定檔](configuring/metadata-profiles.md)
   + [中繼資料資料夾結構描述](configuring/metadata-folder-schemas.md)
...
+ 搜尋和探索{#search-and-discovery}
   ...
   + [AI 搜尋](./search-and-discovery/ai-search.md)
   + [Adobe Firefly 整合](./search-and-discovery/adobe-firefly.md)
...
+ 進階功能{#advanced}
   + [3D 資產](./advanced/3d-assets.md)
   + [註解 PDF 輸出](./advanced/customizing-annotations-pdf-output.md)
   + [資產報告](./advanced/asset-reports.md)
   + [內容認證](./advanced/content-credentials.md)
   + [封鎖的標記](./advanced/blocked-tags.md)
...
+ 進階中繼資料管理{#metadata}
   ...
   + [影像的智慧標記](metadata/image-smart-tags.md)
   + [自訂影像的智慧標記](metadata/custom-smart-tags.md)
   + [影片的智慧標記](metadata/video-smart-tags.md)
   + [匯入和匯出中繼資料](metadata/metadata-import-export.md)

+ Content Hub{#content-hub}
   + [概觀](./content-hub/overview.md)
   + [建立](./content-hub/set-up.md)
   + [設定](./content-hub/configure.md)
   + [新增資產](./content-hub/add-assets.md)
   + [下載資產](./content-hub/download-assets.md)
   + [使用 Adobe Express 的影像變體](./content-hub/image-variants.md)
   + [集合](./content-hub/collections.md)
   + [共用](./content-hub/share.md)
   + [屬性型存取控制](./content-hub/attribute-based-access-control.md)
   + 使用案例{#use-cases}
      + [管理資產](./content-hub/use-cases/manage-assets.md)

+ Edge Delivery Services{#edge-delivery-services}
   + [Sidekick 外掛程式](./edge-delivery-services/sidekick-plugin.md)

+ Adobe GenStudio{#adobe-genstudio}
   + [AEM Assets 和 GenStudio for Performance Marketing](https://experienceleague.adobe.com/zh-hant/docs/integrations-learn/experience-cloud/tutorials/genstudio-for-performance-marketing-experience-manager/overview)
...
+ 共用和分發{#sharing}
   ...
   + 資產共用{#assets-share}
      ...
      + [在本機 AEM 上設定 Asset Share Commons](./sharing/asset-share-commons-technical-video-setup.md)
      + [Asset Share Commons 主題設定](./sharing/asset-share-commons-feature-video-theming.md)
      + [Asset Share Commons 資產套件](./sharing/asset-share/asset-share-commons-asset-kits.md)

+ 創意工作流程{#creative-workflows}
   + [Adobe Express 整合](./creative-workflows/adobe-express.md)
   + [Adobe Express 和 AEM Assets](./creative-workflows/adobe-express-aem-assets.md)
...
+ Adobe Asset Link{#adobe-asset-link}
   ...
   + [存取 Adobe Asset Link](./adobe-asset-link/launch-adobe-asset-link.md)
   ...
   + [版本設定和評論](./adobe-asset-link/file-versioning-and-comments.md)
   + [放置副本](./adobe-asset-link/place-copy.md)
   + [放置連結](./adobe-asset-link/place-linked.md)
...
+ 內容自動化{#content-automation}
   ...
   + [Photoshop 動作](./content-automation/photoshop-actions.md)

+ Dynamic Media{#dynamic-media}
   + [Dynamic Media 概觀](dynamic-media/dynamic-media-overview-feature-video-use.md)
   + [Dynamic Media Classic 桌面應用程式](dynamic-media/dynamic-media-classic-desktop-application.md)
   + 影像 {#images}
      + [URL語法和影像預設集](dynamic-media/dynamic-media-urls-and-image-presets.md)
   ...
   + 影片 {#video}
      + [最佳做法](dynamic-media/dynamic-media-video-best-practices.md)
      + [360 度影片](dynamic-media/dynamic-media-360-video-custom-thumbnail-feature-video-use.md)
      + [自訂影片縮圖](dynamic-media/dynamic-media-video-thumbnails-feature-video-use.md)
      + [DASH 自適應串流](dynamic-media/dynamic-media-dash.md)
      + [Dynamic Media 智慧裁切影片](dynamic-media/dynamic-media-smart-crop-video.md)
   ...
   + 檢視器 {#viewers}
      ...
      + [Adobe Analytics 檢視器](dynamic-media/dynamic-media-viewer-extension-use.md)
   + 3D {#3d}
      + [Dynamic Media 3D](dynamic-media/dynamic-media-3d-feature-video.md)
   + 與 AEM Sites 搭配使用 {#dm-with-aem-sites}
      + [體驗片段](dynamic-media/dynamic-media-experience-fragments-feature-video-use.md)
      + [Dynamic Media 核心元件](dynamic-media/dynamic-media-core-components.md)
   ...
   + 教學課程 {#tutorials}
      ...
      + [建立智慧裁切影像設定檔](dynamic-media/tutorials/creating-image-profile-smart-crop.md)
      + [建立影片設定檔](dynamic-media/tutorials/creating-video-profile-to-process-videos-in-dynamic-media.md)
      ...
      + [產生 URL 和嵌入程式碼](dynamic-media/tutorials/how-to-generate-public-url-or-embed-code-for-an-asset.md)
      + [觸發匯出工作](dynamic-media/tutorials/how-to-trigger-export-job-in-dynamic-media-during-submit-job-operation-parameter.md)
      + [使 CDN 快取無效](dynamic-media/tutorials/invalidating-the-cdn-cache-by-way-of-dynamic-media.md)
      + [使用 Dynamic Media 核心元件](dynamic-media/tutorials/using-dm-components-on-site-page.md)
      + [刪除 Dynamic Media 設定](dynamic-media/tutorials/deleting-dynamic-media-configuration.md)
      + [在 Dynamic Media Classic 應用程式中下載資產](dynamic-media/tutorials/how-to-download-asset-in-dynamic-media-classic-app.md)
      + [Dynamic Media Classic IPS API](dynamic-media/tutorials/introduction-to-dynamic-media-classic-ips-api.md)

+ Workfront 整合{#workfront}
   + 增強型連接器{#enhanced-connector}
      + [增強型連接器基礎知識](./workfront/enhanced-connector/basics.md)
      + [專案資料夾](./workfront/enhanced-connector/project-folders.md)
      + AEM 專家系列{#aem-experts-series}
         + [概觀](./workfront/enhanced-connector/aem-experts-series/overview.md)
         + [建立](./workfront/enhanced-connector/aem-experts-series/setup.md)
         + [Workfront 表單和 AEM 中繼資料](./workfront/enhanced-connector/aem-experts-series/custom-forms.md)
         + [標記、專案連結的資料夾，以及資料夾中繼資料](./workfront/enhanced-connector/aem-experts-series/aem-tags-project-linked-folders-and-folder-metadata.md)
...
+ 資產範本{#asset-templates}
   + [了解資產範本](asset-templates/asset-templates-tutorial-understand.md)
