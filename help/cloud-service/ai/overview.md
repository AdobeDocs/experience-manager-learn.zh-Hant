---
title: Experience Manager中的AI
description: 探索Adobe Experience Manager as a Cloud Service內的AI，透過智慧型功能加強內容管理和交付。
...
# Experience Manager中的AI

Experience Manager中的![AI](./assets/overview/hero.png)

Experience Manager as a Cloud Service提供進階AI功能，以增強內容管理、簡化工作流程並改善使用者體驗。 透過整合AI支援的功能，例如AEM AI Assistant和AEM AI代理程式，使用者可以自動化工作、獲得見解並最佳化內容傳送。
...
<div class="columns">
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./setup.md" title="在AEM中設定AI" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3474066/?format=jpeg&nocache=1772461889360" alt="在AEM中設定AI"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./setup.md" target="_blank" rel="referrer" title="在AEM中設定AI">在AEM中設定AI</a>
                    </p>
                    <p class="is-size-6">瞭解在AEM中使用AI所需的存取權。</p>
                </div>
                <a href="./setup.md" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">設定</span>
                </a>
            </div>
        </div>
    </div>
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="AEM AI Assistant">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./ai-assistant.md" title="AEM AI 助理" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3475357/?format=jpeg&nocache=1772461889318" alt="AEM AI 助理"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./ai-assistant.md" target="_blank" rel="referrer" title="AEM AI 助理">AEM AI小幫手</a>
                    </p>
                    <p class="is-size-6">瞭解AI Assistant如何在AEM中提供產品知識和支援。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Agents in AEM">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./agents/agents-in-aem.md" title="AEM中的代理程式" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3478455/?format=jpeg&nocache=1772461889348" alt="AEM中的代理程式"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        AEM中的<a href="./agents/agents-in-aem.md" target="_blank" rel="referrer" title="AEM中的代理程式">代理程式</a>
                    </p>
                    <p class="is-size-6">瞭解AI支援的代理程式如何在AEM中自動化任務並增強工作流程。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Generate Variations">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="../../sites/generative-ai/generate-variations.md" title="產生變化版本" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3427946/?format=jpeg&nocache=1772461889329" alt="產生變化版本"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="../../sites/generative-ai/generate-variations.md" target="_blank" rel="referrer" title="產生變化版本">產生變化版本</a>
                    </p>
                    <p class="is-size-6">Adobe Experience Manager 中的「產生變化版本」能夠針對任何體驗將文字和影像最佳化。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="AI Search">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="../../assets/search-and-discovery/ai-search.md" title="AI 搜尋" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3479989/?format=jpeg&nocache=1772461889339" alt="AI 搜尋"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="../../assets/search-and-discovery/ai-search.md" target="_blank" rel="referrer" title="AI 搜尋">AI 搜尋</a>
                    </p>
                    <p class="is-size-6">瞭解AEM AssetsAI 搜尋如何以智慧化方式呈現相關資產並啟用更聰明的搜尋體驗，藉以強化搜尋。</p>
                </div>
