...
可直接從擴充功能註冊代碼呼叫Adobe I/O Runtime動作。 最常見的使用案例是將動作繫結到 [頁首功能表](https://developer.adobe.com/uix/docs/services/aem-cf-console-admin/api/header-menu/)不使用的按鈕 [模態](./modal.md).
