---
title: 建立自定義流程步驟
description: 使用PDF將Word、Excel附件轉換為Document Cloud的自定義流程步驟。
...
以下是自定義流程步驟的完整代碼，該代碼將轉換本機檔案並用轉換的pdf檔案替換。此自定義步驟將搜索作為工作流進程參數提供的資料夾名稱下的所有附件。
此自定義進程步驟使用自定義DocumentCloudSDKService的方法建立PDF。
