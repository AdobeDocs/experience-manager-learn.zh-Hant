...
+ 個人化 {#personalization}
   ...
   + 設定{#setup}
      + [整合Adobe Target](./personalization/setup/integrate-adobe-target.md)
      + [整合標籤](./personalization/setup/integrate-adobe-tags.md)
   + 使用案例 {#use-cases}
      + [實驗（A/B測試）](./personalization/use-cases/experimentation.md)
+ AEM API{#aem-apis}
   + [概觀](./apis/overview.md)
   + OpenAPI{#openapis}
