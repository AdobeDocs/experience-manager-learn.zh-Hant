...
+ AI {#ai}
   ...
   + [設定與布建](./ai/setup.md)
   + AI 助理 {#ai-assistant}
      + [概觀](./ai/ai-assistant/overview.md)
      + [什麼是AI助理？](./ai/ai-assistant/what-is-ai-assistant.md)
      + [誰的AI Assistant？](./ai/ai-assistant/who-is-ai-assistant-for.md)
      + [主要功能](./ai/ai-assistant/key-capabilities.md)
      + [AI Assistant與Agentic AI](./ai/ai-assistant/ai-assistant-and-agentic-ai.md)
   + 代理程式 {#agents}
      + [概觀](./ai/agents/agents-in-aem.md)
      + [開發代理程式和CI/CD疑難排解](./ai/agents/development-agent-troubleshoot-ci-cd-pipeline.md)
   + MCP伺服器 {#mcp-servers}
      + [概觀](./ai/mcp/overview.md)
      + [使用MCP伺服器加速AEM內容作業](./ai/mcp/accelerate-content-operations-with-aem-mcp-server.md)
      + [Cloud Manager MCP伺服器](./ai/mcp/cloud-manager.md)
   + AI輔助開發 {#ai-assisted-development}
      + [概觀](./ai/ai-assited-development/overview.md)
      + 設定{#setup}
         + [代理程式技能](./ai/ai-assited-development/setup/agent-skills.md)
      + 使用案例{#use-cases}
         + [元件開發](./ai/ai-assited-development/use-cases/component-development.md)
...
+ 開發{#developing}
   ...
   + 進階{#advanced}
      ...
      + [尋找及移除已棄用的API](./developing/advanced/deprecated-apis-find-removal.md)
   + 快速開發環境{#rde}
...
+ 個人化 {#personalization}
   ...
   + [即時示範](./personalization/live-demo.md)
   + 設定{#setup}
   ...
   + 使用案例 {#use-cases}
      ...
      + [行為定向](./personalization/use-cases/behavioral-targeting.md)
      + [已知使用者Personalization](./personalization/use-cases/known-user-personalization.md)
+ AEM API{#aem-apis}
   + [概觀](./apis/overview.md)
   + OpenAPI{#openapis}
...
+ 驗證{#authentication}
   ...
   + [SAML登入鉤點](./authentication/saml-2-0-login-hook.md)
+ 進階網路{#networking}
...
+ Forms{#forms}
   ...
   + 在提交表單時於AEP中建立設定檔{#aep-integration}
      + [簡介](./forms/aep-integration/introduction.md)
      + [建立雲端設定](./forms/aep-integration/create-cloud-configuration.md)
      + [設定AEP提交的表單](./forms/aep-integration/create-integration-with-aep.md)
   + 互動式通訊教學課程{#interactive-communication-tutorial}
      + [&#x200B;1. 簡介](./forms/interactive-communication-tutorial/introduction.md)
      + [&#x200B;2. 建立FDM](./forms/interactive-communication-tutorial/create-form-data-model.md)
      + [&#x200B;3. 建立範本](./forms/interactive-communication-tutorial/create-template.md)
      + [&#x200B;4. 建立片段](./forms/interactive-communication-tutorial/create-fragments.md)
      + [&#x200B;5. 建立IC檔案](./forms/interactive-communication-tutorial/create-ic-document.md)
      + [&#x200B;6. 產生IC檔案](./forms/interactive-communication-tutorial/test-document-generation.md)
