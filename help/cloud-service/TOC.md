...
+ 開發{#developing}
   + 擴展性{#extensibility}
      + 應用程式生成器{#app-builder}
         + [生成訪問令牌](./developing/extensibility/app-builder/jwt-auth.md)
      + 內容片段控制台{#content-fragments}
         + [概觀](./developing/extensibility/content-fragments/overview.md)
         + [Adobe Developer控制台項目](./developing/extensibility/content-fragments/adobe-developer-console-project.md)
         + [應用程式初始化](./developing/extensibility/content-fragments/app-initialization.md)
         + [分機註冊](./developing/extensibility/content-fragments/extension-registration.md)
         + [標題菜單](./developing/extensibility/content-fragments/header-menu.md)
         + [操作欄](./developing/extensibility/content-fragments/action-bar.md)
         ...
         + 擴展示例{#example-extensions}
            + [批量屬性更新](./developing/extensibility/content-fragments/example-extensions/bulk-property-update.md)
            + [使AEM用OpenAI生成影像資產](./developing/extensibility/content-fragments/example-extensions/image-generation-and-image-upload.md)
   + 開發基本概念{#basics}
   ...
   + 進階{#advanced}
      + [Web優化的映像API](./developing/advanced/web-optimized-image-delivery-java-apis.md)
      + [服務用戶](./developing/advanced/service-users.md)
      + [自定義命名空間](./developing/advanced/custom-namespaces.md)
      + [快取頁變型](./developing/advanced/variant-caching.md)
   + 快速發展環境{#rde}
      + [概觀](./developing/rde/overview.md)
      + [如何設定](./developing/rde/how-to-setup.md)
      + [如何使用](./developing/rde/how-to-use.md)
...
+ 調試AEM{#debugging}
   ...
   + 調試AEMas a Cloud Service{#debugging-aem-as-a-cloud-service}
      ...
      + 風險{#risks}
         + [遍歷警告](./debugging/cloud-service/risks/traversals.md)
...
+ Forms{#forms}
   ...
   + AEM Forms與分析{#forms-and-analytics}
      ...
      + [Test解決方案](./forms/form-data-analytics/test.md)
   ...
   + Acrobat Sign與AEM Forms{#forms-and-sign}
      ...
      + [Acrobat SignAPI應用程式](./forms/forms-and-sign/create-sign-api-application.md)
      + [Acrobat Sign雲配置](./forms/forms-and-sign/create-adobe-sign-cloud-configuration.md)
   ...
   + 與MicrosoftPower Automet整合{#forms-cs-and-power-automate}
      ...
      + [從提交的資料中提取表單附件](./forms/forms-cs-and-power-automate/send-af-attachments-in-email.md)
   ...
   + 將表單提交儲存在一個驅動器和Sharepoint中{#one-drive}
      + [將表單資料儲存在一個驅動器中](./forms/forms-cs-one-drive/store-form-submission-one-drive.md)
      + [在Sharepoint中儲存表單資料](./forms/forms-cs-sharepoint/store-form-submission-in-sharepoint.md)
...
+ 專家資源 {#expert-resources}
   + 冠AEM軍 {#aem-champions}
      + [雲管理員登機手冊](./expert-resources/aem-champions/onboarding-playbook.md)
      + [Cloud Manager環境類型](./expert-resources/aem-champions/environment-types.md)
      + [雲管理器UI](./expert-resources/aem-champions/cloud-manager-ui.md)
   + [專AEM家系列](./expert-resources/expert-series/aem-experts-series.md)
   + 雲5{#cloud-5}
      + [簡介](./expert-resources/cloud-5/cloud5-introduction.md)
      + [第一季](./expert-resources/cloud-5/cloud5-season-1.md)
      + [第二季](./expert-resources/cloud-5/cloud5-season-2.md)
      + [AEMCDN第1部分](./expert-resources/cloud-5/cloud5-aem-cdn-part1.md)
      + [AEMCDN第2部分](./expert-resources/cloud-5/cloud5-aem-cdn-part2.md)
      + [日誌AEM檔案](./expert-resources/cloud-5/cloud5-aem-log-files.md)
      + [登錄令牌](./expert-resources/cloud-5/cloud5-getting-login-token-integrations.md)
      + [雲調度程式](./expert-resources/cloud-5/cloud5-aem-dispatcher-cloud.md)
      + [遷移1](./expert-resources/cloud-5/cloud5-aem-content-migration-part-1.md)
      + [遷移2](./expert-resources/cloud-5/cloud5-aem-content-migration-part-2.md)
      + [調度程式驗證程式](./expert-resources/cloud-5/cloud5-aem-dispatcher-validator.md)
      + [搜索和索引](./expert-resources/cloud-5/cloud5-aem-search-and-indexing.md)
      + [Adobe應用生成器](./expert-resources/cloud-5/cloud5-adobe-app-builder.md)
      + 第二季{#season-2}
         + [片段](./expert-resources/cloud-5/season-2/cloud5-experience-v-content-fragments.md)
         + [回購現代化者](./expert-resources/cloud-5/season-2/cloud5-repo-modernizer.md)
         ...
         + [Sling作業計畫程式](./expert-resources/cloud-5/season-2/cloud5-sling-job-scheduler.md)
         + [修復快取](./expert-resources/cloud-5/season-2/cloud5-fix-your-cache.md)
         + [修復重寫](./expert-resources/cloud-5/season-2/cloud5-fix-your-rewrites.md)
         + [雲管理器 — 體驗審核](./expert-resources/cloud-5/season-2/cloud5-mocm-experience-audit.md)
         + [雲管理器 — 設備Test](./expert-resources/cloud-5/season-2/cloud5-mocm-unit-tests.md)
         + [雲管理器 — 功能Test](./expert-resources/cloud-5/season-2/cloud5-mocm-functional-tests.md)