...
需要存取AEM作者服務的使用者在[Adobe的Admin Console](https://helpx.adobe.com/tw/enterprise/using/set-up-identity.html)中被管理為[Adobe IMS使用者](https://adminconsole.adobe.com)。 了解何謂 Adobe IMS 使用者，以及如何在 Admin Console 中對其進行存取和管理。
