...
AEM Author的CDN確實快取了多種可能值得關注的資源型別，包括對持續性查詢[的](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/headless/graphql-api/persisted-queries.html?lang=zh-Hant&author-instances)可自訂TTL，以及對自訂使用者端資料庫[的](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/caching.html?lang=zh-Hant#client-side-libraries)長TTL。
