...
[Jupyter Notebook](https://jupyter.org/)是開放原始碼的Web應用程式，可讓您建立包含程式碼、文字和視覺效果的檔案。 它用於資料轉換、視覺化和統計模型製作。 它可以作為Adobe Experience Platform[的一部分從遠端](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/data-science-workspace/jupyterlab/analyze-your-data)存取。
