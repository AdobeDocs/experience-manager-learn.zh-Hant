...
1. **傳統網站**&#x200B;使用 AEM Author 的頁面編輯器製作內容，然後啟動該內容，並透過 AEM Publish 以 HTML 網頁格式傳遞給一般使用者。
1. **Edge Delivery Services** 網站利用文件型製作或 Adobe 通用編輯器來製作內容，然後啟動該內容，並透過 Edge Delivery Services 以 HTML 網頁格式傳遞給一般使用者。
1. **無周邊/API 優先**&#x200B;的網頁體驗會使用內容片段編輯器或通用編輯器來製作內容，然後啟動該內容，並透過 AEM Publish 以 JSON 的格式傳遞。
...
|            | 傳統網站 | Edge Delivery Services | 無周邊/API 優先 |
|---------------------|------------------------------|---------------------------------|---------------------------------------------|
| **製作工具** | 頁面編輯器 | 文件型製作、通用編輯器 | 內容片段、通用編輯器 |
| **製作內容儲存** | AEM Author (JCR) | 文件或 AEM Author (JCR) | AEM Author (JCR) |
| **傳遞** | AEM Publish (透過 Adobe CDN + Dispatcher) | Edge Delivery Services | AEM Publish (透過 Adobe CDN + Dispatcher) |
| **傳遞內容儲存** | AEM Publish (JCR) | Edge Delivery Services | AEM Publish (JCR) |
| **傳遞格式** | HTML | HTML | JSON |
| **開發技術** | Java™、JavaScript、CSS | JavaScript、CSS | 任何 (例如 Swift、React 等) |
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/zh-hant/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/overview" title="傳統網站 - WKND 教學課程" target="_self" rel="referrer">
                        <img class="is-bordered-r-small" src="./assets/aem-wknd-spa-editor-tutorial.png" alt="傳統網站 - WKND 教學課程"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/zh-hant/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/overview" target="_self" rel="referrer" title="傳統網站 - WKND 教學課程">傳統網站 - WKND 教學課程</a>
                    </p>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">了解如何建置由 AEM 內容支援的無周邊應用程式。教學課程涵蓋 iOS、Android™ 和 React 等框架，請選擇適合您堆疊的框架。</p>
                </div>
