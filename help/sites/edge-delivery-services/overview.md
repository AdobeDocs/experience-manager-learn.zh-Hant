...
description: 瞭解如何使用Edge Delivery快速建立網站。
...
<div class="columns is-multiline">
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen"
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/prerequisites.md" title="安裝節點"
              tabindex="-1">
              <img class="is-bordered-r-small"
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./developing/prerequisites.md" title="安裝節點">安裝節點</a>
            </p>
            <p class="is-size-6">如何安裝Node JS的簡短概觀。</p>
            <a href="./developing/prerequisites.md" class="spectrum-Button
              spectrum-Button--outline spectrum-Button--primary
              spectrum-Button--sizeM">
              <span class="spectrum-Button-label has-no-wrap
        ...
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/aem-boilerplate.md" title="使用樣板範本"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3425713/?format=jpeg" alt="設定樣板">
            </a>
          </figure>
        </div>
        <div class="card-content is-padded-small">
