...
AEM內容片段是文字型編輯內容，其中可能包含某些相關聯的結構化資料元素，但被視為不含設計或版面配置資訊的純內容。 內容片段通常建立為與管道無關的內容，其用途為跨管道使用和重複使用，這反過來又會在內容特定的體驗中包裝內容。

本影片系列涵蓋AEM中內容片段的製作生命週期。 詳細資訊 [遞送內容片段可在此處找到](content-fragments-delivery-feature-video-use.md).
...
>[!NOTE]
>
> 中引進了內容片段的註解和版本比較 [AEM 6.4 Service Pack 2](https://helpx.adobe.com/tw/experience-manager/aem-releases-updates.html) 和 [AEM 6.3 Service Pack 3](https://helpx.adobe.com/experience-manager/6-3/release-notes/sp3-release-notes.html).
