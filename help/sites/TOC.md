...
+ 檔案製作{#document-authoring}
   ...
   + 如何{#how-to}
      ...
      + [檔案工作流程](./document-authoring/how-to/document-workflows.md)
      ...
      + 產生變數{#generate-variations}
         ...
         + [Adobe Target對象](./document-authoring/how-to/generate-variations/using-target-audiences.md)
         + [CSV檔案對象](./document-authoring/how-to/generate-variations/using-csv-file-audiences.md)
         ...
         + [信任與隱私權](./document-authoring/how-to/generate-variations/trust-privacy.md)
...
+ Edge Delivery Services{#edge-delivery-services}
   ...
   + 正在開發{#developing}
      ...
      + 通用編輯器 {#universal-editor}
         ...
         + [新增AEM網站](./edge-delivery-services/developing/universal-editor/2-new-aem-site.md)
