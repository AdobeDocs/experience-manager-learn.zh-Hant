...
+ 頁面創作 {#page-authoring}
   ...
   + 專家建議 {#expert-advice}
      + [站點層次結構提示](page-authoring/expert-advice/site-hierarchy.md)
+ 元件 {#components}
   + [元件開發](components/component-development.md)
   + [核心元件](components/core-components-feature-video-understand.md)
   + [Web優化映像交付](components/web-optimized-image-delivery.md)
...
+ 開發 {#developing}
   ...
   + [響應斷點](developing/responsive-breakpoints.md)
...
+ 整合 {#integrations}
   ...
   + Experience Platform資料收集標籤（啟動） {#experience-platform-data-collection-tags}
      ...
      + [使用AEMIMS連接和標籤屬性](integrations/experience-platform/data-collection/tags/connect-aem-tag-property-using-ims.md)
      + [建立啟AEM動Cloud Service](integrations/experience-platform/data-collection/tags/create-aem-launch-cloud-service.md)
      + [調試標籤（啟動）實現](integrations/experience-platform/data-collection/tags/debug-tags-implementation.md)
...
+ 專家資源 {#expert-resources}
   ...
   + [站點維護](expert-resources/site-maintenance.md)
   + [AEM冠軍技巧和技巧：會話1](expert-resources/champion-tips-1.md)
   + [AEM冠軍技巧和技巧：會議2](expert-resources/champion-tips-2.md)