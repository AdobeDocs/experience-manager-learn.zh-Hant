...
您可以隨意嘗試其他元件。 關於每個專案的檔案 [您可以在這裡找到核心元件](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html). 詳細影片系列介紹 [頁面製作可在此處找到](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/aem-sites-authoring-overview.html).
...
1. 下 **選項** 將預設設定保留為 **發佈** 並排程 **現在**. 按一下&#x200B;**下一步**。
