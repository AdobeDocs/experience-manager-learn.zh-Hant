---
title: 內容片段主控台影片
description: 了解讓您輕鬆管理和製作內容片段的 AEM 內容片段主控台！
...
![AEM 內容片段編輯器](./assets/main.png)

Adobe Experience Manager 的內容片段主控台讓內容片段的管理與製作變得簡單！透過這些影片了解如何充分利用內容片段主控台。

檢閱此[文件](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/content-fragments/content-fragments-console.html?lang=zh-Hant)，了解關於內容片段主控台及其功能的完整詳細資訊。
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./basics/content-fragments-console.md" title="概觀">主控台概觀</a>
            </p>
            <p class="is-size-6">內容片段主控台的簡略
              概觀。</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./search/fast-filtering.md" title="快速篩選">快速
                篩選</a>
            </p>
            <p class="is-size-6">使用內嵌篩選快速找到
              內容片段。</p>
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">1 分鐘</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./editor/new-editor-toggle.md" title="新編輯器切換">新
                編輯器切換</a>
            </p>
            <p class="is-size-6">從經典編輯器順暢轉換成新版
              編輯器。</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">將體驗片段和頁面合併到您的
              內容片段中。</p>
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">1 分鐘</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./editor/rte-variant-compare.md" title="RTE 變體
                比較">RTE 變體比較</a>
            </p>
            <p class="is-size-6">輕鬆地讓各管道 RTF 文字內容
              保持一致。</p>
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">1 分鐘</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./editor/language-copies.md" title="語言副本">語言
                副本</a>
            </p>
            <p class="is-size-6">輕鬆管理您的內容片段語言
              副本</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./search/references.md" title="參照">參照</a>
            </p>
            <p class="is-size-6">了解內容片段的參照和關係。</p>
