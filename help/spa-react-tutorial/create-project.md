---
title: SPA編輯器專案 |開始使用AEM SPA Editor and React
description: 了解如何使用Adobe Experience Manager(AEM)Maven專案，作為與AEM SPA編輯器整合的React應用程式的起點。
sub-product: Sites
...
# SPA編輯器專案{#spa-editor-project}

了解如何使用Adobe Experience Manager(AEM)Maven專案，作為與AEM SPA編輯器整合的React應用程式的起點。
...
在本章中，將根據[AEM專案原型](https://github.com/adobe/aem-project-archetype)部署新的AEM專案。 AEM專案將以React SPA的簡單起點啟動。 本章中使用的項目將作為實施WKND SPA的基礎，並將在以後的章節中構建。
...
3. 從[AEM專案原型](https://github.com/Adobe-Marketing-Cloud/aem-project-archetype/releases/tag/aem-project-archetype-14)產生AEM專案時，已使用下列屬性：
   ...
   | 套件 | com.adobe.aem.guides.wknd.spa.react |
   | includeExamples | n |

   >[!NOTE]
   >
   > 請注意`frontendModule=react`屬性。 這會告訴AEM專案原型以使用要與AEM SPA編輯器搭配使用的起始程式碼基底[React程式碼基底](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/developing/archetype/uifrontend-react.html)引導專案。
...
5. 您應該會看到`wknd-spa-react.all`、`wknd-spa-react.ui.apps`和`wknd-spa-react.ui.content`的三個套件。
...
2. 選擇頁面並按一下菜單欄中的&#x200B;**[!UICONTROL Edit]**&#x200B;按鈕，開啟&#x200B;**[!DNL us]** > **[!DNL en]** > **[!DNL WKND SPA React Home Page]**&#x200B;頁：
...
1. 在&#x200B;**[!UICONTROL 頁面編輯器]**&#x200B;中，按一下&#x200B;**[!UICONTROL 頁面資訊]**&#x200B;按鈕> **[!UICONTROL 檢視為已發佈]**:
