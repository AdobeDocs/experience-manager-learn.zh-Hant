...
> 如需如何使用AEM as a Cloud Service設定OKTA的說明，請參閱[SAML 2.0驗證](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/authentication/saml-2-0.html)。
