---
title: 無AEM頭Tutorials
description: 關於如何將Adobe Experience Manager用作無頭CMS的教程集
...
<tr>
  <td>
    ...
    <p>
    <em>瞭解應用程式如何AEM使用GraphQL API查詢內容。</em>
    <p>
  </td>
  <td>
...
<tr>
  <td>
    ...
    <p>
    <em>由GraphQL API支援的iOSAEM應用程式。</em>
    <p>
  </td>
  <td>
    ...
    <p>
    <em>由GraphQL API支援的Android™AEM應用程式。</em>
    </p>
  </td>
  <td>
    ...
    <p>
    <em>由GraphQL API支援的AEMReact應用程式。</em>
    <p>
  </td>
</tr>
</table>
...
<tr>
  <td>
    ...
    <p>
    <em>在純無頭情形中使用GraphQL構建React JS應用。</em>
    <p>
  </td>
  <td>
