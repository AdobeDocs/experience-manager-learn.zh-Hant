...
此多部份教學課程的目的為教導開發人員如何實作 Angular 應用程式，以使用 AEM 的 SPA Editor 功能。 在真實世界情況中，開發活動會依人物誌細分，通常包含&#x200B;**前端開發人員**&#x200B;和&#x200B;**後端開發人員**。 我們相信任何參與 AEM SPA 編輯器專案的開發人員，在完成此教學課程後都將獲益。

此教學課程在設計上將使用 **AEM as a Cloud Service**，並向下相容於 **AEM 6.5.4+** 和 **AEM 6.4.8+**。 使用以下項目實作 SPA：

* [Maven AEM專案原型](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html?lang=zh-Hant)
...
>[!NOTE]
>
> **剛開始使用AEM as a Cloud Service？** 請參閱[以下指南以使用AEM as a Cloud Service SDK](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/local-development-environment-set-up/overview.html?lang=zh-Hant)設定本機開發環境。
>
> **第一次使用AEM 6.5？** 請檢視[下列指南以設定本機開發環境](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/development/set-up-a-local-aem-development-environment.html?lang=zh-Hant)。

## 後續步驟 {#next-steps}

您還在等什麼?! 導覽至[SPA Editor專案](create-project.md)章節，開始進行教學課程，並瞭解如何使用AEM專案原型產生啟用SPA Editor的專案。
