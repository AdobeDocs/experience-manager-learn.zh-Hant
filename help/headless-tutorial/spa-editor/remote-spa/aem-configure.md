...
接下來，設定AEM以保護內容，使只有此SPA可以存取AEM內容。 在AEM[&#128279;](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/security/develop-for-cross-origin-resource-sharing.html)中設定跨原始資源共用。
